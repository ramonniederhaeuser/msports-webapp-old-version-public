...
<div class="container mt-5">
  ...
  <p>MsportS<br>
    ...
    9562 Märwil<br>
    Schweiz<br>
    <a href="mailto:info@msports.ch">info@msports.ch</a><br>
    <a href="https://www.msports.ch/" target="_blank">msports.ch</a>
  </p>
  <h2>Vertretungsberechtigte Personen</h2>
  <p>Marco Spiri, (The Coach) Inhaber<br>
     Ramon Niederhäuser, Verantwortlicher Web-Applikation</p>
  ...
  <p>Der Autor übernimmt keinerlei Gewähr hinsichtlich der inhaltlichen Richtigkeit, 
     ...
     zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.</p>
  ...
  <p>Verweise und Links auf Webseiten Dritter liegen ausserhalb unseres Verantwortungsbereichs.<br> 
     ...
     oder der Nutzerin.</p>
  <h2>Urheberrechte</h2>
  <p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf der Website gehören ausschliesslich der Firma MsportS oder den speziell genannten Rechtsinhabern. Für die Reproduktion jeglicher Elemente ist die schriftliche Zustimmung der Urheberrechtsträger im Voraus einzuholen.</p>
  <h2>Quelle</h2>
  <p>Dieses Impressum wurde am 28.12.2020 durch den Applikationsverantwortlichen 
     Ramon Niederhäuser erstellt. <br>
     Die o.g. Person übernimmt keine Haftung.</p>
</div>
<?php 
